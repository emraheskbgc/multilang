...
function Header() {
    const navbar = ["Home", "Cari", "Banka","Kasa","Gelir","Gider"]
  ...
  return (
    <>
        ...
        <aside className='z-30  flex-shrink-0 w-64 overflow-y-auto bg-gray-900'>
            <div className='py-4 text-gray-400 '>
                ...
                <ul className='mt-6'>
                   {navbar.map((item,index) => (
                    ...
                    <Link onClick={()=>handleClickItem(index)} href={`/${locale}/login`}
