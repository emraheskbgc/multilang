      ...
      <div className="flex flex-col overflow-y-auto md:flex-row">
        ...
        <main className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
          <div className="w-full">
            ...
            <hr className="my-8"/>
            <p className="mt-4"> 
                <Link className="text-sm font-medium text-purple-400 hover:underline "  href={`/${locale}/forgot-password`} >
                    {t('forgotYourPassword')}
                </Link>
            </p>
            <p className="mt-1"> 
            <Link className="text-sm font-medium text-purple-400 hover:underline " href={`/${locale}/signup`}>
                {t('createAccount')}
            </Link>
        </p>
          </div>
